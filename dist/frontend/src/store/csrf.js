            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (options.method.toUpperCase() !== 'GET') {
                        ...
                        options.headers['XSRF-Token'] = js_cookie_1.default.get('XSRF-TOKEN');
                    }
                    if (!(options.method.toUpperCase() === 'GET')) return [3 /*break*/, 2];
                    return [4 /*yield*/, window.fetch(url)];
                case 1:
                    res = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, window.fetch(url, options)];
                case 3:
                    res = _a.sent();
                    _a.label = 4;
                case 4:
