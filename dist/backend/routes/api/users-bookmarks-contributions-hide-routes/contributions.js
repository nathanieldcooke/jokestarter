...
var formatContibutions = require('../../../utils/routeDataAggregators').formatContibutions;
var asyncHandler = require('express-async-handler');
var restoreUser = require('../../../utils/auth').restoreUser;
var _a = require('../../../db/models'), Project = _a.Project, SupportTier = _a.SupportTier, UsersToSupportTier = _a.UsersToSupportTier;
...
router.get('/page/:pageNumber', restoreUser, asyncHandler(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                data = _a.sent();
                return [4 /*yield*/, formatContibutions(data, pageNumber, user)];
            case 2:
